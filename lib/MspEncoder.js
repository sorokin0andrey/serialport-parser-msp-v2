...
var encode = function (_a) {
    ...
    if (msp2) {
        ...
        result_1.writeUInt8(exports.checksum(result_1.slice(headerSize_1, result_1.length - 1)), result_1.length - 1);
        return result_1;
    }
    else {
...
var checksum = function (buffer) {
    return buffer.reduce(function (crc, n) { return Msp_1.crc8_dvb_s2(crc, n); }, 0);
};
